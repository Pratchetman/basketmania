const nextFinalRound = (schedule) => {
  ...
  // Ronda previa
  if (parseInt(schedule[0][0].pointsAway) > parseInt(schedule[0][0].pointsHome)) {
  ...
  if (parseInt(schedule[0][1].pointsAway) > parseInt(schedule[0][1].pointsHome)) {
  ...
  if (
    ...
    (parseInt(schedule[1][0].pointsHome) + parseInt(schedule[2][0].pointsHome))
  ){
  ...
  if (
    ...
    (parseInt(schedule[1][1].pointsHome) + parseInt(schedule[2][1].pointsHome))
  ){
  ...
  if (
    ...
    (parseInt(schedule[1][2].pointsHome) + parseInt(schedule[2][2].pointsHome))
  ){
  ...
  if (
    ...
    (parseInt(schedule[1][3].pointsHome) + parseInt(schedule[2][3].pointsHome))
  ){
  ...
  if (
    ...
    (parseInt(schedule[3][0].pointsHome) + parseInt(schedule[4][0].pointsHome))
  ){
  ...
  if (
    ...
    (parseInt(schedule[3][1].pointsHome) + parseInt(schedule[4][1].pointsHome))
  ){
